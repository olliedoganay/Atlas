...
- Version check: `node scripts\run_repo_python.mjs scripts\check_atlas_version.py --tag v1.0.26`
...
- Release tags must match manifest versions, for example `v1.0.26`.
